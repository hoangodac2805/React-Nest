...
interface UseDataTableProps<TData> extends Omit<TableOptions<TData>, "getCoreRowModel" | "state" | "manualPagination"> {
    paginate?: PaginationMetaType
}

export function useDataTable<TData>({ paginate, ...props }: UseDataTableProps<TData>) {
